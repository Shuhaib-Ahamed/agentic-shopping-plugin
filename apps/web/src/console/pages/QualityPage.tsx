    ...
    <div className="space-y-5">
      <header>
        ...
        <p className="text-[13px] text-muted">
          Tool errors, schema failures, suspected hallucinations.
        </p>
      </header>
      ...
      <MetricGrid>
        ...
        <KpiCard
          ...
          value={data ? formatNumber(data.summary.schemaFailures) : "–"}
        />
        <KpiCard
          label="Hallucinations"
          value={data ? formatNumber(data.summary.hallucinations) : "–"}
        />
      </MetricGrid>
              ...
              {data.toolErrors.map((t) => (
                <tr key={t.name} className="border-t border-[color:var(--color-border)]">
                  ...
                  <td className="py-2 text-right tabular">
                    <span
                      className={
                        t.errorRate > 0.05 ? "text-[color:var(--color-status-err)]" : "text-muted"
                      }
                    >
